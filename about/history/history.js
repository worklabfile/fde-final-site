const translations = {
    'ru': {
        ...
        'history.title': 'История ФЦЭ',
        'history.creation.title': 'Создание',
        'history.creation.text': 'Факультет цифровой экономики (ФЦЭ) Белорусского государственного экономического университета был основан 1 августа 2019 года в соответствии с решением Совета университета. Его создание стало ответом на стремительное развитие цифровых технологий и потребность в специалистах, способных работать на стыке экономики, IT и аналитики.',
        'history.2019': '2019 г.',
        'history.2019.text': 'Факультет образован по решению Совета университета для подготовки кадров в области цифровой экономики.',
        'history.2020': '2020 г.',
        'history.2020.text': 'Запуск первых междисциплинарных программ с участием IT-компаний-партнеров.',
        'history.2022': '2022 г.',
        'history.2022.text': 'Вхождение в топ-3 самых востребованных факультетов БГЭУ по проходным баллам.',
        'history.mission.title': 'Миссия с первого дня',
        'history.mission.text': 'Подготовка специалистов, способных трансформировать бизнес и госуправление с помощью цифровых технологий. Факультет продолжает развиваться, оставаясь флагманом цифрового образования в Беларуси.',
    ...
    'be': {
        ...
        'history.title': 'Гісторыя ФЦЭ',
        'history.creation.title': 'Стварэнне',
        'history.creation.text': 'Факультэт лічбавай эканомікі (ФЦЭ) Беларускага дзяржаўнага эканамічнага ўніверсітэта быў заснаваны 1 жніўня 2019 года ў адпаведнасці з рашэннем Савета ўніверсітэта. Яго стварэнне стала адказам на імклівае развіццё лічбавых тэхналогій і патрэбу ў спецыялістах, здольных працаваць на стыку эканомікі, IT і аналітыкі.',
        'history.2019': '2019 г.',
        'history.2019.text': 'Факультэт створаны па рашэнні Савета ўніверсітэта для падрыхтоўкі кадраў у галіне лічбавай эканомікі.',
        'history.2020': '2020 г.',
        'history.2020.text': 'Запуск першых міждысцыплінарных праграм з удзелам IT-кампаній-партнёраў.',
        'history.2022': '2022 г.',
        'history.2022.text': 'Уваходжанне ў топ-3 самых папулярных факультэтаў БДЭУ па праходных балах.',
        'history.mission.title': 'Місія з першага дня',
        'history.mission.text': 'Падрыхтоўка спецыялістаў, здольных трансфармаваць бізнэс і дзяржаўнае кіраванне з дапамогай лічбавых тэхналогій. Факультэт працягвае развівацца, застаючыся флагманам лічбавай адукацыі ў Беларусі.',
    ...
    'en': {
        ...
        'history.title': 'History of FDE',
        'history.creation.title': 'Establishment',
        'history.creation.text': 'The Faculty of Digital Economy (FDE) of the Belarusian State Economic University was founded on August 1, 2019, by the decision of the University Council. Its creation was a response to the rapid development of digital technologies and the need for specialists capable of working at the intersection of economics, IT and analytics.',
        'history.2019': '2019',
        'history.2019.text': 'The faculty was established by the decision of the University Council to train personnel in the field of digital economy.',
        'history.2020': '2020',
        'history.2020.text': 'Launch of the first interdisciplinary programs with participation of partner IT companies.',
        'history.2022': '2022',
        'history.2022.text': 'Ranked among top 3 most popular faculties of BSEU by admission scores.',
        'history.mission.title': 'Mission from day one',
        'history.mission.text': 'Training specialists capable of transforming business and public administration through digital technologies. The faculty continues to develop, remaining the flagship of digital education in Belarus.',
    ...
    'zh': {
        ...
        'history.title': '数字经济学院历史',
        'history.creation.title': '成立',
        'history.creation.text': '白俄罗斯国立经济大学数字经济学院(FDE)根据大学理事会的决定于2019年8月1日成立。它的创建是对数字技术快速发展的回应，也是为了满足对能够在经济学、IT和分析交叉领域工作的专业人才的需求。',
        'history.2019': '2019年',
        'history.2019.text': '根据大学理事会决定成立该学院，旨在培养数字经济领域人才。',
        'history.2020': '2020年',
        'history.2020.text': '启动首批有IT合作伙伴公司参与的跨学科项目。',
        'history.2022': '2022年',
        'history.2022.text': '以录取分数进入白俄罗斯国立经济大学最受欢迎院系前三名。',
        'history.mission.title': '自成立之初的使命',
        'history.mission.text': '培养能够通过数字技术改变商业和公共管理的专业人才。学院继续发展，保持白俄罗斯数字教育的领先地位。',
